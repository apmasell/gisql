...
public class ListDescriptor extends Parseable<Type, TypeNesting> {

	public static Parseable<Type, TypeNesting> self = new ListDescriptor();
	...
	public Type construct(ExpressionRunner runner, List<Type> params,
		...
		return new ListType(params.get(0));
	}
