...
import ca.wlu.gisql.function.pair.PairKey;
import ca.wlu.gisql.function.pair.PairValue;
...
public class BuiltInResolver implements ResolutionEnvironment {
	...
	static {
		...
		addDefault(Pair.class);
		addDefault(PairKey.class);
		addDefault(PairValue.class);
