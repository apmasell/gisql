...
public class JaccardCoreicityDescriptor implements Parseable {

	private static final Token[] tokens = new Token[] { new Word("jaccardcore") };
	...
	public AstNode construct(Environment environment, List<AstNode> params,
		...
		if (interactome.isInteractome()) {
			return new AstJaccardCoreicity(interactome);
		} else {
			return null;
		}
	}
	...
	public void show(ShowablePrintWriter<ParserKnowledgebase> print) {
		print.print("Jaccard coreicity scorer: A:jaccardcore");
